...
export default function ServicePage() {
    ...
    return cars
      .filter((car) => {
        const matchesCharacter =
          filterCharacter === "All" || car.character === filterCharacter;
        const matchesSearch =
          car.name.toLowerCase().includes(searchQuery) ||
          car.character.toLowerCase().includes(searchQuery);
  ...
  const selectedCar =
    selectedIndex !== null ? filteredCars[selectedIndex] : null;
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://64.media.tumblr.com/71d57427121375eb9d09d6402abce356/408b809db59ae567-0f/s2048x3072/56c05856bdae82185e8c015a6e141d591d457fc4.jpg')",
        }}
      >
        <div className="bg-black/60 absolute inset-0"></div>
        <h1 className="relative text-5xl md:text-6xl font-bold text-red-500 drop-shadow-lg">
          Fast Cars Showcase
        </h1>
      </section>
          ...
          >
            ...
            <motion.div className="bg-gray-900 rounded-2xl p-6 max-w-lg w-full text-center relative z-10">
              ...
              <p className="text-gray-300 mb-1">
                Driven by {selectedCar.character}
              </p>
              ...
              <div className="flex justify-between mt-4">
                <button
                  onClick={prevCar}
                  className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-xl font-semibold"
                >
                  ← Previous
                </button>
                <button
