...
export default function ServicePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Hero */}
      <section className="relative h-[60vh] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('https://64.media.tumblr.com/71d57427121375eb9d09d6402abce356/408b809db59ae567-0f/s2048x3072/56c05856bdae82185e8c015a6e141d591d457fc4.jpg')" }}>
      ...
      <section className="max-w-6xl mx-auto py-8 px-6">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {filteredCars.map((car, index) => (
            <motion.div key={car.id} className="relative group rounded-2xl overflow-hidden shadow-lg cursor-pointer z-10"
